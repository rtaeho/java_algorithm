...
public class BOJ32154 {
    public static void main(String[] args) throws IOException {
        ...
        // 순위별 푼 문제의 수와 문제 리스트를 저장하는 Map 생성
        ...
        // 입력받은 N등에 해당하는 문제 수와 문제 번호 출력
        List<String> problems = rankData.get(N);
        System.out.println(problems.size());  // 푼 문제 수 출력
        System.out.println(String.join(" ", problems));  // 문제 번호 사전 순 출력
    }
}
